...
<body>
                        ...
                        <nav class="navbar h-100 navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="studioMenu">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="detail.php">About us</a>
                                    </li>
    ...
    <div class="social-sidebar-area bg-white">
		...
		<div class="social-info-area">
            <a href="detail.php" data-toggle="tooltip" data-placement="right" title="Resepsi pernikahan"><i class="fa fa-calendar" aria-hidden="true"></i> <span>Tanggal H</span></a>
            ...
            <a href="detail.php" data-toggle="tooltip" data-placement="right" title="Video gallery"><i class="fa fa-video-camera" aria-hidden="true"></i> <span>Pinterest</span></a>
        ...
        <div class="message-box">
            <a href="#"><img src="img/core-img/envelope.png" alt=""></a>
        </div>
    </div>
        ...
        <div class="carousel h-100 slide" data-ride="carousel" id="welcomeSlider">
            ...
            <div class="carousel-inner h-100">
                ...
                <div class="carousel-item h-100 bg-img active" style="background-image: url(img/bg-img/1.jpg);">
                    ...
                    <div class="carousel-content h-50">
                ...
                <div class="carousel-item h-100 bg-img" style="background-image: url(img/bg-img/4.jpg);">
                    <div class="carousel-content h-100">
                        <div class="slide-text">
                            <h2>“Jika ada manusia belum hidup bersama pasangannya, berarti hidupnya akan timpang dan tidak berjalan sesuai dengan ketetapan Allah SWT dan orang yang menikah berarti melengkapi agamanya, sabda Rasulullah SAW: "Barangsiapa diberi Allah seorang istri yang sholihah, sesungguhnya telah ditolong separoh agamanya. Dan hendaklah bertaqwa kepada Allah separoh lainnya.” (HR. Baihaqi).</h2>
                        </div>
                    </div>
                </div>
                <div class="carousel-item h-100 bg-img" style="background-image: url(img/bg-img/5.jpg);">
                    ...
                    <div class="carousel-content h-75">
                        <div class="slide-text">
                            <h2 style="text-align: center">"Jagalah cinta yang ada di hatimu, Hidup tanpa cinta adalah taman tanpa sinar matahari yang membuat bunga - bunga menjadi mati" <br><br>
                            - Oscar Wilde -</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item h-100 bg-img" style="background-image: url(img/bg-img/7.jpg);">
                    <div class="carousel-content h-100">
                        <div class="slide-text">
                            <h2><b>Dear Calon Imam, Dengarkan Harapan Calon Makmummu Ini</b><br/><br>
                            <p style="color: white; padding: 0px">ENGKAU, wahai calon imamku yang tertulis di Lauhul Mahfudz. Bimbing aku bersamamu. Beri aku pengetahuan atas ketidakpahamanku. Nasihati aku dengan lembut. Didik aku dengan sabar</p></h2>
                        </div>
                    </div>
                    <h2>source:</h2>
                </div>
